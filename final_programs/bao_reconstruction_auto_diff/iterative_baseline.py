...
_PROJECT_ROOT = '/home/tianyi/real_tianyi/code/MadEvolve-Cosmo/final_programs/bao_reconstruction_auto_diff'
...
def main():
    ...
    import time
    start = time.time()
    recon_field = reconstruct(data, R_init=10.0, R_min=1.0, decay_factor=0.5, n_iterations=8)
